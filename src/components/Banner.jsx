    ...
    <div className="relative bg-cover bg-[url('https://i.ibb.co/Nt04vW6/survey-banner.jpg')] bg-no-repeat max-w-7xl mx-auto">
     <div className="absolute inset-0 bg-white opacity-90"></div>
      <div className="relative flex flex-col justify-center items-center h-[350px] md:h-[400px] lg:h-[495px]">
            <div className='bg-white p-6 md:p-10 lg:px-20 lg:py-16 mt-16'>
            ...
            <button className='bg-purple-800 mx-auto px-4 md:px-8 py-2 md:py-3 text-white rounded-md text-xs md:text-base font-medium flex items-center gap-3'>
                Explore More
