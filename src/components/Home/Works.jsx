    ...
    <div className="my-20 max-w-7xl mx-auto bg-purple-100 py-20">
        <Container>
            ...
            <div className="bg-white p-6 md:p-8 lg:p-10 rounded-md">
                <div
                    className="relative after:absolute after:inset-x-0 after:top-[20px] md:after:top-1/2 after:block after:h-[1px] md:after:h-0.5 after:-translate-y-1/2 after:rounded-lg after:bg-gray-200"
                >
                    <ol
