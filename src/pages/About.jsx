      ...
      <Container>
        ...
        <div className="mb-20 flex flex-col-reverse md:flex-row items-center justify-between gap-10">
            <div className="md:w-3/4 lg:flex-1">
                ...
                <p className="text-xs lg:text-sm leading-6 text-gray-500">OutPoll is your platform to voice opinions that truly count. Your perspectives wield influence over products, services, and pivotal decisions. Join our community and become a driving force in shaping a future that aligns with your unique viewpoint. Your participation empowers transformative change!</p>
            </div>
            <div className="">
